...
-   **Mental Health Indicator**
    ...
    whether this child is diagnosed to have mental health issues. Except
    for 8 health problems, we also have the information that whether
    this child has taken treatments/medication or not.
